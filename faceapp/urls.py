...
from faceapp.views import LoginView, HomeView, LogoutView, DepartmentListView, DepartmentDetailView, EmployeeDetail, \
    ...
    get_statistics_employee_working_hours_ajax, get_statistics_department
...
urlpatterns = [
    ...
    path('get_statistics_employee_working_hours_ajax/', get_statistics_employee_working_hours_ajax,
         name='get_statistics_employee_working_hours_ajax'),
    path('get_statistics_department/', get_statistics_department, name='get_statistics_department'),
]
